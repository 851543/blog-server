...
public class SysUserServiceImpl implements ISysUserService {
     ...
     */
    @Override
    public int bindEmail(EmailVO emailVO) {
        SysUser user = new SysUser();
        ...
        String cacheCode = redisCache.getCacheObject(CacheConstants.MAIL_CODE_KEY + emailVO.getEmail());
        if (cacheCode == null || !cacheCode.equals(emailVO.getCode())) {
