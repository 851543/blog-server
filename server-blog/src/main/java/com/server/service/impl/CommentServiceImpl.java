...
import com.server.util.HTMLUtil;
...
import static com.server.enums.CommentTypeEnum.*;
...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    @Autowired
    private AuroraInfoService serverInfoService;
    ...
    public void saveComment(CommentVO commentVO) {
        ...
        WebsiteConfigDTO websiteConfig = serverInfoService.getWebsiteConfig();
        ...
        String fromNickname = SecurityUtils.getLoginUser().getUser().getNickName();
    ...
    public void checkCommentVO(CommentVO commentVO) {
        ...
        if (Objects.nonNull(commentVO.getParentId())) {
            ...
            if (Objects.isNull(commentVO.getReplyUserId())) {
                ...
                SysUser existUser = sysUserMapper.selectUserById(commentVO.getReplyUserId().longValue());
    ...
    private void notice(Comment comment, String fromNickname) {
        ...
        if (Objects.nonNull(comment.getParentId())) {
            ...
            if (!comment.getReplyUserId().equals(parentComment.getUserId())
                ...
                SysUser userInfo = sysUserMapper.selectUserById(comment.getUserId().longValue());
                SysUser replyUserinfo = sysUserMapper.selectUserById(comment.getReplyUserId().longValue());
        ...
        SysUser userInfo = sysUserMapper.selectUserById(userId.longValue());
    ...
    private EmailDTO getEmailDTO(Comment comment, SysUser userInfo, String fromNickname, String topicId, String title) {
        ...
        if (comment.getIsReview().equals(TRUE)) {
            ...
            if (Objects.isNull(comment.getParentId())) {
                ...
                if (!userInfo.getUserId().equals(parentComment.getUserId())) {
                    userInfo = sysUserMapper.selectUserById(parentComment.getUserId().longValue());
                }
                emailDTO.setEmail(userInfo.getEmail());
                emailDTO.setSubject(COMMENT_REMIND);
                ...
                if (!comment.getReplyUserId().equals(parentComment.getUserId())) {
                    SysUser mentionUserInfo = sysUserMapper.selectUserById(comment.getReplyUserId().longValue());
            ...
            String adminEmail = sysUserMapper.selectUserById(Long.valueOf(BLOGGER_ID)).getEmail();
